...
import {fetchData, registerToChildChanged, registerToChildAdded, registerToChildRemoved} from '../../utils/generalDBUtils';
import {fbCollectionReceived, fbChildChanged, fbChildAdded, fbChildRemove, fbClearCollection} from '../../redux/actions/actionCreators'
        ...
        function Wrapper() {
            return (
                <ReactReduxContext.Consumer>
                    {({ store }) => {
                        return (<ContainerComponent store={store}/>)
                    }}
                </ReactReduxContext.Consumer>
            )
        }
